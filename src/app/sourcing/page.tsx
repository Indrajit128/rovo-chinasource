...
const stats = [
  {
    ...
    desc: "Direct access to verified suppliers across Guangdong, Zhejiang, and Jiangsu hubs.",
  },
  {
    val: "35%",
    label: "Average Cost Reductions",
    desc: "Acquire direct factory price points by completely eliminating trading companies.",
  },
  {
    val: "100%",
    label: "Strict Quality Checks",
    desc: "On-site AQL inspections ensure zero defect containers are loaded.",
  },
];
...
export default function SourcingPage() {
  return (
    <main style={{ minHeight: "100vh", background: "#F8FAFC" }}>
      {/* ── Hero ── */}
      <section
        className="product-catalog-hero"
        style={{ background: "none", paddingBottom: "5rem" }}
      >
        <div style={{ position: "absolute", inset: 0, zIndex: 0 }}>
          ...
          <div
            style={{
              ...
              inset: 0,
              background:
                "linear-gradient(135deg, rgba(15,23,42,0.90) 0%, rgba(30,41,59,0.84) 60%, rgba(15,23,42,0.92) 100%)",
            }}
          />
        </div>
        ...
        <div className="container" style={{ position: "relative", zIndex: 1 }}>
          ...
          >
            ...
            <p className="product-hero-sub" style={{ marginBottom: "2.5rem" }}>
              Leverage our boots-on-the-ground presence in China&apos;s top
              manufacturing districts. We handle every procurement phase locally
              so you build your brand risk-free.
            </p>
            <div
              style={{
                display: "flex",
      ...
      >
        <div className="container">
          ...
          >
            <motion.div {...fadeUp}>
              <span
                className="section-eyebrow orange"
              ...
              >
                ...
                <span style={{ color: "#C62828" }}>growth and success</span> of
                our clients.
              </h2>
      ...
      <section id="process" className="section bg-white">
        <div className="container">
          ...
          >
            ...
            >
              A battle-tested 8-step methodology refined across hundreds of
              successful China–India trade operations.
            </p>
          </motion.div>
          <div
            style={{
        ...
        <div className="container">
          <motion.div {...fadeUp} className="product-cta-block">
            ...
            <p className="product-cta-sub">
              Submit your sourcing brief today and our Guangzhou team will
              respond with a shortlist of verified manufacturers within 24
              hours.
            </p>
